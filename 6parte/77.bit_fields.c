...
void logmsg(FILE *fp, char *message, unint8_t options) {
...
int main() {
  ...
  logmsg(stdout, "The wheels are comming off!", LOG_TIME | LOG_USER | LOG_COUNT);
  logmsg(stdout, "AAAAARGH.", LOG_COUNT);
  logmsg(stdout, "AAAAARGH.", LOG_ALL);
  logmsg(stdout, "AAAAARGH.", LOG_FULLTIME);
}